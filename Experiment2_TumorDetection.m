...
for q=1:number_of_trials
    ...
    if shapethereornot(1,q) == 1 && whichone(1,q) == 1 %for the d' value
        hits = hits + 1;
    elseif shapethereornot(1,q) == 0 && whichone(1,q) == 0
        falsealarms = falsealarms + 1;
    end
end
dprime = (hits*(hits/number_of_trials))-(falsealarms*(falsealarms/number_of_trials));
...
save('Results.mat',  'isserialdependence', 'actualaccuracy', 'number_of_trials', 'dprime');
